...
namespace Gekkota.Net.Sockets
{
    ...
    public class IPClient : IDisposable
    {
        ...
        public virtual void Send(Datagram datagram, IPEndPoint remoteEndPoint)
        {
            ...
            //
            // calculate the total length of the outgoing datagram
            //
            int totalLength = BaseOverhead  // headers
                            + data.Length;  // payload

            //
            // limit bandwidth usage
            //
            outgoingBandwidthManager.WaitForPass(totalLength);
        ...
        protected virtual void OnListen(byte[] data, EndPoint remoteEndPoint)
        {
            if (data != null) {
                if (receive != null) {
                    ...
                    if (datagrams != null) {
                        incomingBandwidthManager.WaitForPass(data.Length);
